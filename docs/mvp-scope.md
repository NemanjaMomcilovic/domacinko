...
- **Brze akcije** na početnoj: trošak, plan obroka, Savetnik, kupovina
- **Uvod (3 koraka)**: ime → budžet → prvi trošak — pominje samo 4 osnovne funkcije
...
1. Prati troškove i mesečni budžet
...
| Skeniranje računa | `scan-receipt.html` | OCR |
